...
public class GroundEditorPageViewModel : EditorPageViewModel
{
        ...
        public GroundEditorPageViewModel(NodeFactory nodeFactory, PageFactory pageFactory, TabEvents tabEvents, IDialogService dialogService, NodeBase node) : base(nodeFactory, pageFactory, tabEvents, dialogService)
        { }
