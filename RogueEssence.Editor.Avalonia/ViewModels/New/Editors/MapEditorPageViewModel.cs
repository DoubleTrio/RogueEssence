...
public class MapEditorPageViewModel : EditorPageViewModel
{
    public MapEditorPageViewModel(NodeFactory nodeFactory, PageFactory pageFactory, TabEvents tabEvents,
        ...
        MapTabPropertiesViewModel properties) : base(nodeFactory, pageFactory, tabEvents, dialogService)
    {
        Textures = textures;
