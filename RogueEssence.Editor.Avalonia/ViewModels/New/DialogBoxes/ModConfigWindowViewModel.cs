...
namespace RogueEssence.Dev.ViewModels
{
    ...
    {
        public ModConfigWindowViewModel(IDialogService dialogueService, ModHeader header)
        {
            Name = header.Name;
            ...
            Relationships = new CollectionBoxViewModel(dialogueService, new StringConv(typeof(RelatedMod), new object[0]));
